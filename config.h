 ...
 */
// char font[] = "Inconsolata:pixelsize=18:antialias=true:autohint=true";
// char font[] = "Iosevka SS10
// Medium:pixelsize=18:antialias=true:autohint=true";
char font[] = "Jetbrains Mono Medium:pixelsize=17:antialias=true:autohint=true";
// char font[] = "Cascadia Code PL:pixelsize=16:antialias=true:autohint=true";

// char font[] = "Tamsyn:pixelsize=18:antialias=false:autohint=false";
// char font[] = "Liberation Mono:pixelsize=16:antialias=true:autohint=true";
// char font[] = "Terminus:pixelsize=16:antialias=false:autohint=false";

// I think hint and antialias don't do anything when using terminus
// char font[] = "Terminus:pixelsize=18:antialias=false:autohint=false";
...
// #include "colors/solarized_light.h"
...
Shortcut shortcuts[] = {
    ...
    { ShiftMask, XK_Up, sscrollup, { .i = 1 } },
    { ShiftMask, XK_Down, sscrolldown, { .i = 1 } },
};
